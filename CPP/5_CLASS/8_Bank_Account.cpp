...
// Program to perform basic banking operations
#include <iostream>
#include <string>
#include <algorithm>
using namespace std;
...
public:
    ...
    string get_accountHolder() { return accountHolder; }
    float get_balance() { return balance; }

    // Setter methods (optional)
    void set_accountNumber(string accountNumber) { this->accountNumber = accountNumber; }
    void set_accountHolder(string accountHolder) { this->accountHolder = accountHolder; }
    ...
    void deposit(float amount)
    {
        ...
        balance += amount;
        cout << "Dear Customer, Account " << accountNumber << " has been credited for Rs." << amount
    ...
    void withdraw(float amount)
    {
        ...
        {
            balance -= amount;
            cout << "Dear Customer, Account " << accountNumber << " has been debited for Rs." << amount
                 << " your new balance is Rs." << balance << endl;
        }
        else
        {
...
//  Pass pointer by reference so changes reflect in main()
...
{
    float amount;
    int choice, size_array_of_objects = 10, count = 0, flag = 0;
    string accountNumber;

    // Initial dynamic array of BankAccount objects
